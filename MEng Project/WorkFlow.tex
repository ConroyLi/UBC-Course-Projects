...
\subsection{Work for DTMB5415}
\begin{enumerate}
    \item domain is too large and the too many elements --> simulation time out
    \item back to reduce y and test for 4 maxNonlinearIteration -->test 10
    \item make be try the DTMB wave condition again
\end{enumerate}
\end{document}