...
print("dFax1=",latex(partial_F_a_x1), "dFax2=",latex(partial_F_a_x2))
print("dFbx2=",partial_F_b_x1, "dFbx2=",partial_F_b_x2)
print("dFc=",latex(F_c_prime))

print(latex(stationary_points_a), latex(stationary_points_b), latex(stationary_points_c))
print(latex(Hessian_a),latex(Hessian_b), latex(F_c_double_prime))

print(latex(Hessian_a_at_stationary_a), latex(Hessian_b_at_stationary_b), latex(second_derivative_at_stationary_c))
...
print(definiteness_a, definiteness_b)
