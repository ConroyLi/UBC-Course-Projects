...
Pars.Nx = 5;                     % Select number of lattice size
Pars.Ny = 5;                     % Select number of lattice size
Pars.Nz = 5;                     % Select number of lattice size
...
Pars.Temp = 300;    %Call color pallet for plotting
Pars.kb = 8.617333262145e-5;
Pars.kbT = Pars.Temp*8.617333262145e-5; % Thermodynamic factor in eV
Pars.NN = 12;                     % Nearest neighbor in fcc lattice.
Pars.nu0 = 44e12;                 % Hz: Debye frequency
Pars.h  = 4.135667696e-15; %Planck's constant in eVxHz
Pars.hbar = Pars.h/(2*pi); %eVxHz
%% How many vacancies
