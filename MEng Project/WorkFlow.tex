...
\subsection{Day 12}
\begin{enumerate}
    \item Do the spring case instead of having the hydrostaticoutflow off
    \item check the definition files from the VIV case and the wave tank case
    \item tune for stiffness
    \item chop the steps to see what is wrong
    \item build the wave tank domain again as well the ship domain to be same so they could be replaced easily
    \item test for vaibhav wave conditions
