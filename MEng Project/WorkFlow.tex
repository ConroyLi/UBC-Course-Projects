...
\begin{enumerate}
    ...
    \item orgin of the ship to the lowest point is 0.12m, so the wave should be generated at 0.284m - 0.12m = 0.164m
...
\begin{enumerate}
    ...
    \item wave case test 7 with the src files given by Ishan
\end{enumerate}
